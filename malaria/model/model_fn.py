# -*- coding: utf-8 -*-
"""
Created on Thu Nov 15 13:39:41 2018
...
def build_model(is_training, inputs, params):
    ...
    for i, c in enumerate(channels):
        with tf.variable_scope('block_{}'.format(i+1)):
            ...
            pool = not pool # pool in alternate layers
            
    assert out.get_shape().as_list() == [None, 7, 7, num_channels * 8]
    
    out = tf.reshape(out, [-1, 7 * 7 * num_channels * 8])
